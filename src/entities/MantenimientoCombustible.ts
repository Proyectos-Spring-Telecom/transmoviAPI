...
export class MantenimientoCombustible {
  ...
  @Column("decimal", { name: "PrecioCombustible", nullable: true, precision: 10, scale: 2 })
  ...
  @ManyToOne(() => CatTipoCombustible, (catTipoCombustible) => catTipoCombustible.mantenimientosCombustible, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
  ...
  @ManyToOne(() => Instalaciones, (instalaciones) => instalaciones.mantenimientosCombustible, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
  ...
  @ManyToOne(() => Operadores, (operadores) => operadores.mantenimientosCombustible, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
