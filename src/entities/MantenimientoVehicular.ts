...
export class MantenimientoVehicular {
  ...
  @ManyToOne(
    () => Instalaciones,
    (instalaciones) => instalaciones.mantenimientosVehiculares,
    {
      onDelete: 'NO ACTION',
      onUpdate: 'NO ACTION',
    },
  ...
  @ManyToOne(
    ...
    (catEstatusMantenimiento) =>
      catEstatusMantenimiento.mantenimientosVehiculares,
    {
      onDelete: 'NO ACTION',
      onUpdate: 'NO ACTION',
    },
  ...
  @ManyToOne(
    ...
    (catReferenciaServicio) => catReferenciaServicio.mantenimientosVehiculares,
    {
      onDelete: 'NO ACTION',
      onUpdate: 'NO ACTION',
    },
